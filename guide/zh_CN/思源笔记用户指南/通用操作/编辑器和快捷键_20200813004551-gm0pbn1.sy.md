...
应用层快捷键暂时还没有支持，后续会逐步完善 🙏
{: id="20200813175135-7bugfe6"}
...
| 书签页签 | <kbd>Alt 2</kbd> / <kbd>⌘ 2</kbd> |
| 联动大纲页签 | <kbd>Alt 3</kbd> / <kbd>⌘ 3</kbd> |
| 联动反向链接页签 | <kbd>Alt 4</kbd> / <kbd>⌘ 4</kbd> |
| 联动关系图页签 | <kbd>Alt 5</kbd> / <kbd>⌘ 5</kbd> |
| 全局关系图页签 | <kbd>Alt 6</kbd> / <kbd>⌘ 6</kbd> |
{: id="20200821101049-k6zoc42"}

{: id="20200921112100-gblx9rm"}
